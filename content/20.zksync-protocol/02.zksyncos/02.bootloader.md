...
The function  [`run_prepared`](https://github.com/matter-labs/zksync-os/blob/main/basic_bootloader/src/bootloader/mod.rs) implements this
top-level main loop.

### Configuration

The bootloader can be configured with the following parameters
(found in the [`BasicBootloaderExecutionConfig`](https://github.com/matter-labs/zksync-os/blob/main/basic_bootloader/src/bootloader/config.rs) struct):
