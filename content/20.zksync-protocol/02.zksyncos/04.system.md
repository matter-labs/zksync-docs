...
We start by describing the [system struct](https://github.com/matter-labs/zksync-os/blob/main/zk_ee/src/system/mod.rs).
...
[`SystemFunctions`](https://github.com/matter-labs/zksync-os/blob/main/zk_ee/src/system/base_system_functions.rs) trait. Most of them are used to
...
The system functions are implemented in [this directory](https://github.com/matter-labs/zksync-os/tree/main/basic_system/src/system_functions).
