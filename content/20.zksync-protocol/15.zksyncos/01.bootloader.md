...
a [System Hook](/zksync-protocol/zksyncos/hooks-and-flows#system-hooks). This interplay is described
in [Runner Flow](/zksync-protocol/zksyncos/hooks-and-flows#runner-flow).
