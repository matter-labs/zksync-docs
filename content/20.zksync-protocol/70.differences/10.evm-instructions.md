...
## Address Derivation in the EVM Emulator

The **EVM Bytecode Emulator** ensures that contract addresses generated with `create` and `create2` match Ethereum’s derivation logic.
...
Learn more about [the EVM Bytecode Emulator](../evm-emulator/overview).
