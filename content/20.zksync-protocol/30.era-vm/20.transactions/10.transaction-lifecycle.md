...
For details on fees, refer to the [fee model documentation](/zksync-protocol/era-vm/transactions/fee-model).
...
- `fee`: `U256`. See the [fee mechanism documentation](/zksync-protocol/era-vm/transactions/fee-model) for more information.
...
[Learn more about contract deployment in ZKsync](/zksync-protocol/era-vm/differences/contract-deployment).
...
For more on transaction completion and irrevocability, see the [finality documentation](/zksync-protocol/rollup/finality).
...
When using RPC methods like [`eth_getTransactionByHash`](https://ethereum.github.io/execution-apis/api/methods/eth_getTransactionByHash),
...
ZKsync Chains use this for features like [native account abstraction](/zksync-protocol/era-vm/account-abstraction) and [paymasters](/zksync-protocol/era-vm/account-abstraction/paymasters).
