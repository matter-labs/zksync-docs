...
[opcode](/zksync-protocol/era-vm/contracts/bootloader).
...
- `txNumberInBatch` the number of the transaction in the batch where the log has happened. This number is taken from the
  ...
  [called](/zksync-protocol/era-vm/contracts/bootloader).
...
[Batches and L2 blocks on ZKsync](/zksync-protocol/era-vm/transactions/blocks).
...
Please read [Bootloader](/zksync-protocol/era-vm/contracts/bootloader) and
[System contracts](/zksync-protocol/era-vm/contracts/system-contracts)
on the general system contracts / bootloader structure as well as the pubdata structure with Boojum system to understand
[the difference](/zksync-protocol/era-vm/transactions/fee-model/how-we-charge-for-pubdata)
