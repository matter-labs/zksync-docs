...
[Learn more about EIP712 transactions here](/zksync-protocol/era-vm/transactions/transaction-lifecycle#eip-712-0x71).
...
[ContractDeployer system contract](/zksync-protocol/era-vm/contracts/system-contracts)
...
the transaction (as it's an [EIP712 transaction](/zksync-protocol/era-vm/transactions/transaction-lifecycle#eip-712-0x71)). If the contract is a factory
(i.e. it can deploy other contracts), these contracts' bytecodes should be included
in the `factory_deps` as well.

We recommend using the
[hardhat-zksync tooling](/zksync-network/zksync-era/custom-tooling#hardhat-zksync) to
...
[ContractDeployer](/zksync-protocol/era-vm/contracts/system-contracts) system contract accepts
...
[hardhat-zksync tooling](/zksync-network/zksync-era/custom-tooling#hardhat-zksync).
...
- [Security considerations and best practices on ZKsync](/zksync-network/zksync-era/security-best-practices)

### Differences in `create()` behaviour

To facilitate [support for account abstraction](/zksync-protocol/era-vm/account-abstraction), ZKsync splits the nonce of each account
...
[ContractDeployer](/zksync-protocol/era-vm/contracts/system-contracts), which provides the address
...
[ContractDeployer](/zksync-protocol/era-vm/contracts/system-contracts). It is available for EOAs as well.

## Deploying contracts from L1

Deploying contracts on ZKsync Chains is also possible via L1-L2 communication.

The [interface](https://github.com/matter-labs/era-contracts/blob/main/l1-contracts/contracts/bridgehub/IBridgehub.sol)
...
To learn more about L1-L2 communication on ZKsync, visit [this section of the docs](/zksync-protocol/era-vm/transactions/l1_l2_communication).
