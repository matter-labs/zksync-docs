...
This STF is defined by the [Bootloader](/zksync-protocol/era-vm/contracts/bootloader), which implements and runs it.
...
Additionally, the system includes an optional [EVM Interpreter](../../zksync-protocol/era-vm/evm-interpreter/overview)
