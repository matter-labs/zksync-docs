...
Please read the full article on the [general system contracts / bootloader structure](/zksync-protocol/era-vm/contracts/system-contracts)
as well as the pubdata structure with Boojum system to understand
[the difference](/zksync-protocol/era-vm/transactions/fee-model/how-we-charge-for-pubdata) between system and user logs.
