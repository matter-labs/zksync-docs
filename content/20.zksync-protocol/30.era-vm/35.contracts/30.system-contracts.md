...
about the [block processing](/zksync-protocol/era-vm/transactions/blocks) on ZKsync.
...
- Contains minimal implementation of our account abstraction protocol. Note that it supports the
  [built-in paymaster flows](/zksync-protocol/era-vm/account-abstraction/paymasters).
...
[document](/zksync-protocol/era-vm/contracts/handling-l1-l2-ops).
