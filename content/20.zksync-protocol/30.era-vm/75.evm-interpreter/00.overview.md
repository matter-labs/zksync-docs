...
| **Anvil** | ✅ Works | Forking from a chain with the EVM Interpreter works. **To use EraVM-specific features (i.e. EraVM contracts), [anvil-zksync is required](/zksync-network/zksync-era/custom-tooling#anvil-zksync)**. |
