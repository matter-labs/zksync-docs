...
The [`ecrecover`](/zksync-protocol/era-vm/circuits/circuits/ecrecover)
...
The [`P256Verify` precompile](/zksync-protocol/era-vm/differences/pre-compiles)
...
`isMessageSignatureCorrect` and `isTypedDataSignatureCorrect`.
