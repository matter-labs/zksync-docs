...
chain's Diamond Proxy contract ([see ZKsync Era's](https://etherscan.io/address/0x32400084c286cf3e17e7b677ea9583e60a000324)).
...
coming from the bridge. For example, withdrawal transactions from ZKsync Era appear as transactions from **ZKsync Era: Diamond Proxy** to your wallet address.
