...
### Input
[GitHub](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/linear_hasher/input.rs#L27)
...
### Output
[GitHub](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/linear_hasher/input.rs#L42)
...
[here](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/linear_hasher/mod.rs#L35).

It can be spited into 3 parts:

### First part
[GitHub](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/linear_hasher/mod.rs#L54)
...
### Main part
[GitHub](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/linear_hasher/mod.rs#L105)
...
### Final part
[GitHub](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/linear_hasher/mod.rs#L169)
