---
title: SortDecommitments
description:
---

## SortDecommitments PI

[Input](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/sort_Decommitment_requests/input.rs#L62)
...
[Output](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/sort_Decommitment_requests/input.rs#L81)
...
[FSM Input and FSM Output](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/sort_decommittment_requests/input.rs#L26)
...
[First part](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/sort_decommittment_requests/mod.rs#L51)
...
[Main part](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/sort_Decommitment_requests/mod.rs#L234)
...
[Final part](%%zk_git_repo_era-zkevm_circuits%%/blob/main/src/sort_Decommitment_requests/mod.rs#L191C1-L191C1)
