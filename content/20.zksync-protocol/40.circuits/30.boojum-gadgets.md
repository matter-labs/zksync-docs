---
title: Boojum gadgets
description:
---

Gadgets in ZK programming are common arrangement of circuits abstracted for ease of use.
Boojum gadgets are low-level implementations of tools for constraint systems.
They consist of various types such as curves,
hash functions, lookup tables, and different circuit types.

These gadgets are mostly a reference from
[franklin-crypto](%%zk_git_repo_franklin-crypto%%), with additional hash functions added. These gadgets
...
- [CircuitQueue](%%zk_git_repo_era-boojum%%/blob/main/src/gadgets/queue/mod.rs#L29)
- [FullStateCircuitQueue](%%zk_git_repo_era-boojum%%/blob/main/src/gadgets/queue/full_state_queue.rs#L20C12-L20C33)
