...
ZKsync Gateway is now deprecated. All ZKsync Chains that previously used Gateway for settlement have been migrated to direct L1 settlement.
::
...
See the list of deployed DA validators [here](/zk-stack/customizations/validium).
