...
::callout{icon="i-heroicons-exclamation-triangle" color="amber"}
These methods are under active development.
Their behavior can change in the future, or can be removed without notice.
It is highly advised not to depend on these methods until they are marked as stable.
::
