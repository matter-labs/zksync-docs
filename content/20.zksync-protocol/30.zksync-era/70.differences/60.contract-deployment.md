...
[Learn more about EIP712 transactions here](/zksync-protocol/zksync-era/transactions/transaction-lifecycle#eip-712-0x71).
...
[ContractDeployer system contract](/zksync-protocol/zksync-era/contracts/system-contracts)
...
the transaction (as it's an [EIP712 transaction](/zksync-protocol/zksync-era/transactions/transaction-lifecycle#eip-712-0x71)). If the contract is a factory
...
[ContractDeployer](/zksync-protocol/zksync-era/contracts/system-contracts) system contract accepts
...
- [Security considerations and best practices on ZKsync](/zksync-network/security-best-practices)

### Differences in `create()` behaviour

To facilitate [support for account abstraction](/zksync-protocol/zksync-era/account-abstraction), ZKsync splits the nonce of each account
...
[ContractDeployer](/zksync-protocol/zksync-era/contracts/system-contracts), which provides the address
...
[ContractDeployer](/zksync-protocol/zksync-era/contracts/system-contracts). It is available for EOAs as well.
...
To learn more about L1-L2 communication on ZKsync, visit [this section of the docs](/zksync-protocol/zksync-era/transactions/l1_l2_communication).
