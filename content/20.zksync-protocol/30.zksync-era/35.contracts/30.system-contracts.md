...
about the [block processing](/zksync-protocol/zksync-era/transactions/blocks) on ZKsync.
...
- Contains minimal implementation of our account abstraction protocol. Note that it supports the
  [built-in paymaster flows](/zksync-protocol/zksync-era/account-abstraction/paymasters).
...
[Handling pubdata](/zksync-protocol/zksync-era/transactions/fee-model/how-we-charge-for-pubdata).
...
[document](/zksync-protocol/zksync-era/contracts/handling-l1-l2-ops).
