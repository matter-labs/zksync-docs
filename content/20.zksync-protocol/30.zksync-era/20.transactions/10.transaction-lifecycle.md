...
For details on fees, refer to the [fee model documentation](/zksync-protocol/zksync-era/transactions/fee-model).
...
- `fee`: `U256`. See the [fee mechanism documentation](/zksync-protocol/zksync-era/transactions/fee-model) for more information.
...
[Learn more about contract deployment in ZKsync](/zksync-protocol/zksync-era/differences/contract-deployment).
...
ZKsync Chains use this for features like [native account abstraction](/zksync-protocol/zksync-era/account-abstraction) and [paymasters](/zksync-protocol/zksync-era/account-abstraction/paymasters).
