...
ZKsync is a protocol designed to enable the creation of a network of interoperable zero-knowledge (ZK) L2 rollups and validiums built with [ZKsync Stack](../../zk-stack/index).
...
ZKsync Chains utilizes the latter, leveraging cryptographic proofs for security and efficiency.
