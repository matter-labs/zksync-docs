...
communicating with each other using [L1 <-> L2 interoperability](l1-l2-interoperability).
...
You can get the default bridge addresses using the [`zks_getBridgeContracts`](/build/api-reference/zks-rpc#zks_getbridgecontracts) endpoint or
