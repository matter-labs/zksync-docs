...
- Explore the **[technical details and architecture](./technical-details.md)** of the EVM Emulator.
- Review **[differences from Ethereum (Cancun)](./evm-differences.md)** and their impact on execution.
