...
and ZKsync Chain instances (Layer 2) within ZKsync Era ecosystem.
While we provide overview of ZKsync Era smart contracts here,
it's important to note that this document does *NOT* cover the ZKsync Chain architecture -
communication between multiple rollups and shared liquidity in details.
For information on the ZKsync Chain and its functionalities,
...
`SharedBridge` (more in ZKsync Chain section).
