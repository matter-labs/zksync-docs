...
please refer to [Ecosystem contracts](/build/developer-reference/era-contracts/l1-ecosystem-contracts).
...
There are also important contracts deployed on the L2 that can also execute logic called [system contracts](/build/developer-reference/era-contracts/system-contracts).
...
- STM (State Transition Manager) - Separate smart contract that can perform critical changes to the system as protocol upgrades.
  ...
  [ZK Chain section](/build/developer-reference/era-contracts/l1-ecosystem-contracts#zk-chain-stm).
...
More about L1->L2 operations can be found [here](/build/developer-reference/era-contracts/handling-l1-l2-ops).
