...
These contracts facilitate communication, proof verification, and asset bridging between Ethereum (Layer 1) and individual ZK Chains (Layer 2s)
...
For protocol-level details around cross-chain coordination and ecosystem-level contracts, see [Ecosystem Contracts](/zksync-protocol/contracts/l1-contracts/l1-ecosystem-contracts).
...
The [EVM Bytecode interpreter](../../evm-interpreter/overview) introduced support for
...
(For more details, see the [ZK Chain section](/zksync-protocol/contracts/l1-contracts/l1-ecosystem-contracts).)
