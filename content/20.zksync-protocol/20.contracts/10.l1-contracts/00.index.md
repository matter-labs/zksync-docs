...
There are also important contracts deployed on the L2 that can also execute logic called [system contracts](/zksync-protocol/zksync-era/contracts/system-contracts).
...
[docs](/zksync-protocol/zksync-era/contracts/handling-l1-l2-ops).
...
The [EVM Bytecode interpreter](../../../zksync-protocol/zksync-era/evm-interpreter/overview) introduced support for
...
More information about L1->L2 operations can be found [in Handling L1-L2 Operations](/zksync-protocol/zksync-era/contracts/handling-l1-l2-ops).
...
[in the L2->L1 communication](/zksync-protocol/zksync-era/transactions/fee-model/how-we-charge-for-pubdata).
...
[pubdata post EIP-4844](/zksync-protocol/zksync-era/contracts/pubdata-post-4844) and the one on
[Handling pubdata](/zksync-protocol/zksync-era/transactions/fee-model/how-we-charge-for-pubdata) detailing out the contents.
