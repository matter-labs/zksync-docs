...
You can also read more on [L1->L2 transactions and upgrade transactions](/zksync-protocol/contracts/handling-l1-l2-ops).
...
1. We
  ...
  You can read more on how that works in the [fee model description](/zksync-protocol/rollup/fee-model).
...
5. We
  ...
  the user for any excess funds he spent on the transaction:
    ...
    - The bootloader asks the operator to provide a refund.
      ...
      You can read more about it in [Fee model](/zksync-protocol/rollup/fee-model)
...
You can read more on [Handling pubdata](/zksync-protocol/rollup/fee-model/how-we-charge-for-pubdata).
