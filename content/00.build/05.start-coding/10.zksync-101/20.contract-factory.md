...
The deployment script is located at [`/deploy/deployUsingFactory.ts`][deploy-script].

The deploy script:

- deploys a single `CrowdfundingFactory`.
- saves an instance of the factory to `factoryContract`.
...
"CrowdfundingFactory" was successfully deployed:
 - Contract address: <0xYOUR_FACTORY_CONTRACT_ADDRESS>
...
--contract <0xYOUR_FACTORY_CONTRACT_ADDRESS> \
...
[deploy-script]: https://github.com/matter-labs/zksync-contract-templates/blob/main/templates/101/deploy/2-crowdfunding-factory/deploy.ts
