...
items: [{
  label: 'Transparent',
  partial: '_upgrading/_transparent_proxy_contract_upgradeability'
}, {
  label: 'Beacon',
  partial: '_upgrading/_beacon_proxy_contract_upgradeability'
},
 {
  label: 'UUPS',
  partial: '_upgrading/_uups_contract_upgradeability'
},]
---
::
