...
[a dedicated compiler](../../10.zk-stack/10.components/70.compiler/10.toolchain/10.overview.md)
...
Read more about [ZKsync Era Account Abstraction support](../65.developer-reference/40.account-abstraction/10.introduction.md).
...
We provide [two different testing environments](../60.test-and-debug/00.index.md) designed for local testing purposes.
...
refer to the dedicated [Testing](../60.test-and-debug/00.index.md) page.
