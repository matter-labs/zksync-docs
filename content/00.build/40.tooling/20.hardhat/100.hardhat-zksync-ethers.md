...
This object has the same API as [zksync-ethers](https://staging-sdk-docs.zksync.io/ethers/v6/getting-started), with some extra Hardhat-specific functionality.
