...
- You are already familiar with deploying smart contracts on zkSync. If not, please refer to the first section of the [Contract Deployment](../../65.developer-reference/30.ethereum-differences/60.contract-deployment.md)
- A wallet with sufficient Sepolia `ETH` on Ethereum and %%zk_testnet_name%% to pay for deploying smart contracts.
- You can get Sepolia ETH from the [network faucets](../../../30.ecosystem/60.network-faucets.md).
...
[official zkSync Era compilers](../../../10.zk-stack/10.components/70.compiler/10.toolchain/10.overview.md), with their respective Hardhat plugins.
