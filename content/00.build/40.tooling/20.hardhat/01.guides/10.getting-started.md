...
Learn how to set up and deploy your first ZKsync Era smart contract using Hardhat. Follow the steps below to get your project up and running.
...
::callout{icon="i-heroicons-light-bulb"}
Before you start, ensure you have completed the [installation guide](/build/tooling/hardhat/introduction/installation#installation-steps) and meet
the [prerequisites](/build/tooling/hardhat/introduction/installation#prerequisites). These steps will ensure your environment is correctly
set up for working with ZKsync and Hardhat.
::
...
- Use [ZKsync CLI `create` command](/build/zksync-cli/creating-projects) to quickly scaffold new Hardhat projects using templates.
