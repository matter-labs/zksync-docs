...
- Install [Node.js](https://nodejs.org) if it's not already installed. We recommend using a version supported by Hardhat.
...
If you're migrating an existing hardhat to `zksync-era`, please refer to the [migration guide](/build/tooling/hardhat/guides/migrating-to-zksync) for
