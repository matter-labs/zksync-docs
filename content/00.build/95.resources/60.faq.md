...
bounty program. You can read more about [ZKsync Era security in this section of the docs](./30.audit-bug-bounty.md).
...
Metamask manually by following the instructions in the [interact with ZKsync Era](../01.connect-to-zksync.md) page.
...
[will take ~24 hours, depending on the usage of the ZKsync Era network](./70.withdrawal-delay.md).
