...
At a very high level, Account Abstraction allows us to make authorizations _programmable_, enabling a greater diversity of wallet and protocol design
...
## Why can't I use https://portal.zksync.io/bridge or https://lite.zksync.io/?
In our mission to develop software infrastructure that is resilient, empowering and accessible around the world, we [have an obligation to] do so in alignment with applicable global laws. Some of those laws require blocking wallet addresses with certain risk indicators [involving location or activity], as alerted by third-party screening software.
Please note that these flags are determined by industry-standard third-party providers. We do not expect errors, but if you believe there has been an erroneous block, please email [privacy@matterlabs.dev](mailto:privacy@matterlabs.dev) regarding a process to resolve the issue.
We do not collect any additional or exceptional private data as part of this risk management. Please see our Privacy Policy [link](https://zksync.io/privacy) and Terms of Service [link](https://zksync.io/terms) for the most up-to-date relevant information.
