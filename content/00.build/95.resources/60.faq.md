...
## Why can't I use ZKsync Portal or ZKsync Lite?
...
Please note that these flags are determined by industry-standard third-party providers.
We do not expect errors, but if you believe there has been an erroneous block,
please email [privacy@matterlabs.dev](mailto:privacy@matterlabs.dev) regarding a
process to resolve the issue.

We do not collect any additional or exceptional private data as part of this risk management.
Please see our [Privacy Policy](https://zksync.io/privacy) and
[Terms of Service](https://zksync.io/terms) for the most up-to-date relevant information.
