...
:check-icon Smart contracts are compiled with custom compilers:
**[zksolc and zkvyper](zk-stack/components/compiler/toolchain/overview)**.
...
:check-icon Different **[tools for testing and debugging locally](/build/test-and-debug)**.
