...
You can learn more in the [formal specification](./formal-spec.md).
...
Sometimes we might need to work with larger chunks that do not fit into 16-bit. In this case we can use the (read-only)
code memory as a constant pool and read 256-bit constants from there.
