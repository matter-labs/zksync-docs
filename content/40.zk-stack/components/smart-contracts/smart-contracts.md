...
head:
  - - meta
    - name: 'twitter:title'
      content: Smart Contracts | zkSync Docs
---
...
This document details the architecture of the L2 contracts on Ethereum (also called Layer 1 or L1). We also have
contracts that support the hyperchain ecosystem, we cover those in the [Shared Bridge](../shared-bridges.md) section.
The Shared Bridge relies on these individual contracts.
