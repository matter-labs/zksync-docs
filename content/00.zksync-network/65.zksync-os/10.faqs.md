...
- ZKsync OS provides some additional L2-specific functionality like sending messages to the L1.
...
EraVM and native EraVM account abstraction are not supported.
...
[ERC-4337](https://docs.erc4337.io/) is supported with ZKsync OS.
EIP-7702 is not yet supported, but will be soon.
...
## Will chains that use ZKsync OS be able to use interop?

Yes, chains that use ZKsync OS will also be able to use interop.
