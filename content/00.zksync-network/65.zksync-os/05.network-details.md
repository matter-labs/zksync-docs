...
You can get testnet funds from one of many [testnet faucets](/zksync-network/zksync-era/ecosystem/network-faucets#sepolia-faucets).

### Bridging testnet ETH

You can use the [ZKsync OS Portal](https://zksync-os.portal.zksync.io/) to bridge testnet ETH over.
You can also use `cast` or `zksync-js` as shown in the examples below.
