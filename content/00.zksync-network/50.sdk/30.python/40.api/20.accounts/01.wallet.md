...
| Name    | Description                                                 |
| ------- | ----------------------------------------------------------- |
| returns | [`L1BridgeContracts`](/zksync-era/sdk/python/api/types#l1bridgecontracts) object. |
...
| Name        | Description                                           |
| ----------- | ----------------------------------------------------- |
| transaction | [`Deposittransaction`](/zksync-era/sdk/python/api/types#deposittransaction) |
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/zksync-era/sdk/python/api/types#fulldepositfee).
...
| Name        | Description                                                        |
| ----------- | ------------------------------------------------------------------ |
| transaction | [`RequestExecuteCallMsg`](/zksync-era/sdk/python/api/types#requestexecutecallmsg) object |
