...
This guide provides an overview of the most common operations developers need to start using Swift with ZKsync chains.
...
- **Client**: Provides connection to a ZKsync blockchain, allowing querying of the blockchain state, such as
