...
| Parameter     | Type                                                  | Description                |
| ------------- | ----------------------------------------------------- | -------------------------- |
| `transaction` | [`Deposittransaction`](/zksync-network/sdk/swift/api/types#deposittransaction) | DepositTransaction struct. |
...
| Parameter     | Type                                                                | Description                       |
| ------------- | ------------------------------------------------------------------- | --------------------------------- |
| `transaction` | [`RequestExecuteTransaction`](/zksync-network/sdk/swift/api/types#requestexecutetransaction) | RequestExecuteTransaction struct. |
...
| `options`        | [`TransactionOption`](/zksync-network/sdk/swift/api/types#transactionoption) | Transaction's options which may be used to pass l2 `gasLimit`, `gasPrice`, `value`, etc (optional).                                                 |
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/zksync-network/sdk/swift/api/types#fulldepositfee).
...
| `token`           | `String`                                            | The address of the token. `ETH` by default (optional).                                              |
| `options`         | [`TransactionOption`](/zksync-network/sdk/swift/api/types#transactionoption) | Transaction's options which may be used to pass l2 `gasLimit`, `gasPrice`, `value`, etc (optional). |
| `paymasterParams` | [`PaymasterParams`](/zksync-network/sdk/swift/api/types#paymasterparams)     | Paymaster parameters (optional).                                                                    |
