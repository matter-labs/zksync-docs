...
is used to sign them. You can look at the internal structure of the [EIP712 transactions](/zksync-protocol/zksync-era/transactions/transaction-lifecycle#eip-712-0x71).
