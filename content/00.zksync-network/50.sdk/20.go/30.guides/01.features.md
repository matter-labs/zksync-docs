...
description: An overview of ZKsync specific features
tags: ["zksync", "zksync2-go", "ethereum", "blockchain", "eip-712", "paymaster", "sdk"]
---

While ZKsync chains are mostly Web3-compatible, it has some differences compared to Ethereum. The major of those are:
...
[ZKsync documentation](/zksync-protocol/era-vm/transactions/transaction-lifecycle#eip-712-0x71).
...
[paymaster flows](/zksync-protocol/era-vm/account-abstraction/paymasters#built-in-paymaster-flows)
...
[testnet paymaster](/zksync-protocol/era-vm/account-abstraction/paymasters#testnet-paymaster):
