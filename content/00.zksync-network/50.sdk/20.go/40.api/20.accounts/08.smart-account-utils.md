...
| `client`  | [`*clients.Client`](/zksync-network/sdk/go/api/clients/client)         | The client which fetches data from the network. |
...
Implementation of [`PayloadSigner`](/zksync-network/sdk/go/api/accounts/types#payloadsigner) which signs the payload using
...
| `secret`   | `string`                                    | The ECDSA private key.               |
| `client`   | [`*clients.Client`](/zksync-network/sdk/go/api/clients/client) | Not used and should be `nil`.         |
