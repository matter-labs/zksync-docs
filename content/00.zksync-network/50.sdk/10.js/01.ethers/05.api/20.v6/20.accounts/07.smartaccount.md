...
| ---------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `provider` | [`Provider`](/zksync-network/sdk/js/ethers/api/v6/providers/provider) or `null` | The provider to connect the `SmartAccount` to. If `null`, the `SmartAccount` will be detached from any provider. |
...
By default, uses [`signPayloadWithECDSA`](/zksync-network/sdk/js/ethers/api/v6/utilities/smart-account-utils#signpayloadwithecdsa) and [`populateTransactionECDSA`](/zksync-network/sdk/js/ethers/api/v6/utilities/smart-account-utils#populatetransactionecdsa).

#### Inputs

| Parameter   | Type                                                  | Description                                                             |
| ----------- | ----------------------------------------------------- | ----------------------------------------------------------------------- |
| `signer`    | [`SmartAccountSigner`](/zksync-network/sdk/js/ethers/api/v6/types#smartaccountsigner) | Contains necessary properties for signing payloads.                     |
| `provider?` | [`Provider`](/zksync-network/sdk/js/ethers/api/v6/providers/provider) or `null`       | The provider to connect to. Can be `null` for offline usage. |
...
provided [`TransactionBuilder`](/zksync-network/sdk/js/ethers/api/v6/types#transactionbuilder) function.
If `tx.from` is not set, it sets the value from the `getAddress` method which can
be utilized in the [`TransactionBuilder`](/zksync-network/sdk/js/ethers/api/v6/types#transactionbuilder) function.

#### Inputs

| Parameter | Type                                                  | Description                                 |
| --------- | ----------------------------------------------------- | ------------------------------------------- |
| `tx`      | [`TransactionRequest`](/zksync-network/sdk/js/ethers/api/v6/types#transactionrequest) | The transaction that needs to be populated. |
...
| Parameter | Type                                                  | Description                            |
| --------- | ----------------------------------------------------- | -------------------------------------- |
| `tx`      | [`TransactionRequest`](/zksync-network/sdk/js/ethers/api/v6/types#transactionrequest) | The transaction that needs to be sent. |
...
Signs a `message` using the provided [`PayloadSigner`](/zksync-network/sdk/js/ethers/api/v6/types#payloadsigner) function.
...
Signs the transaction `tx` using the provided [`PayloadSigner`](/zksync-network/sdk/js/ethers/api/v6/types#payloadsigner) function,
...
| Parameter | Type                                                  | Description                              |
| --------- | ----------------------------------------------------- | ---------------------------------------- |
| `tx`      | [`TransactionRequest`](/zksync-network/sdk/js/ethers/api/v6/types#transactionrequest) | The transaction that needs to be signed. |
...
Signs a typed data using the provided [`PayloadSigner`](/zksync-network/sdk/js/ethers/api/v6/types#payloadsigner) function.
...
| `transaction.paymasterParams?` | [`PaymasterParams`](/zksync-network/sdk/js/ethers/api/v6/types#paymasterparams)                          | Paymaster parameters.                                                                           |
