...
Returns an estimated [`Fee`](/zksync-network/sdk/js/ethers/api/v6/types#fee) for the requested transaction.
...
| `paymasterParams?` | [`PaymasterParams`](/zksync-network/sdk/js/ethers/api/v6/types#paymasterparams)              | Paymaster parameters.  |
...
Calls the [`zks_getBaseTokenL1Address`](../../../../../../../zksync-protocol/api/zks-rpc.md#zks_getbasetokenl1address) JSON-RPC method.
...
Calls the [`zks_getBridgehubContract`](../../../../../../../zksync-protocol/api/zks-rpc.md#zks_getbridgehubcontract) JSON-RPC method.
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](/zksync-network/sdk/js/ethers/api/v6/types#network) | Type of ZKsync network. `Localhost` _by default_. |
...
Calls the [`zks_getFeeParams`](../../../../../../../zksync-protocol/api/zks-rpc.md#zks_getfeeparams) JSON-RPC method.
...
Calls the [`zks_getL1BatchBlockRange`](../../../../../../../zksync-protocol/api/zks-rpc.md#zks_getl1batchblockrange)
JSON-RPC method.
...
Returns Merkle [`proofs`](/zksync-network/sdk/js/ethers/api/v6/types#storageproof) for one or more storage values at the
...
Calls the [`zks_getRawBlockTransactions`](../../../../../../../zksync-protocol/api/zks-rpc##zks_getrawblocktransactions)
JSON-RPC method.
...
Returns the [testnet paymaster](/zksync-protocol/era-vm/account-abstraction/paymasters)
...
Calls the [`zks_getTransactionDetails`](../../../../../../../zksync-protocol/api/zks-rpc#zks_gettransactiondetails)
JSON-RPC method.
...
Calls the [`unstable_sendRawTransactionWithDetailedOutput`](../../../../../../../../../zksync-protocol/api/zks-rpc) JSON-RPC method.
