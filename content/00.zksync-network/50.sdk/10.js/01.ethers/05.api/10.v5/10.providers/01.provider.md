...
Returns an estimated [`Fee`](/zksync-network/sdk/js/ethers/api/v5/types#fee) for requested transaction.
...
| Parameter     | Type                                                  | Description          |
| ------------- | ----------------------------------------------------- | -------------------- |
| `transaction` | [`TransactionRequest`](/zksync-network/sdk/js/ethers/api/v5/types#transactionrequest) | Transaction request. |
...
| `paymasterParams?` | [`PaymasterParams`](/zksync-network/sdk/js/ethers/api/v5/types#paymasterparams) | Paymaster parameters.                                                                      |
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](/zksync-network/sdk/js/ethers/api/v5/types#network) | Type of ZKsync network. `Localhost` _by default_. |
...
Returns Merkle [`proofs`](/zksync-network/sdk/js/ethers/api/v5/types#storageproof) for one or more storage values at the specified
...
| Parameter | Type                                                            | Description   |
| --------- | --------------------------------------------------------------- | ------------- |
| `filter`  | [`EventFilter`](/zksync-network/sdk/js/ethers/api/v5/types#eventfilter) or `Promise<EventFilter>` | Filter query. |
