...
::callout
See also [`undol1tol2alias`](/zksync-network/sdk/js/ethers/api/v5/utilities#undol1tol2alias).
::
...
| `ethSignature?` | [`EthereumSignature`](/zksync-network/sdk/js/ethers/api/v5/types#ethereumsignature) | ECDSA signature of the transaction. |
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `receipt` | [`TransactionReceipt`](/zksync-network/sdk/js/ethers/api/v5/types#transactionreceipt) | Transaction receipt. |
...
| Parameter       | Type                                                  | Description                          |
| --------------- | ----------------------------------------------------- | ------------------------------------ |
| `txReceipt`     | [`TransactionReceipt`](/zksync-network/sdk/js/ethers/api/v5/types#transactionreceipt) | Receipt of the L1 transaction.       |
