...
| `provider` | [`Provider`](/zksync-network/sdk/js/ethers/api/v5/providers/provider) | The provider is used to fetch data from the network if it is required for signing. |
