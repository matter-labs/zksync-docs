...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](/zksync-network/sdk/js/ethers/api/v5/providers/provider) | A ZKsync node provider. |
...
| `providerL2?` | [`Provider`](/zksync-network/sdk/js/ethers/api/v5/providers/provider)                                                         | A ZKsync node provider. Needed for interaction with ZKsync. |
...
Returns the [parameters](/zksync-network/sdk/js/ethers/api/v5/types#finalizewithdrawalparams) required for finalizing a withdrawal
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/zksync-network/sdk/js/ethers/api/v5/types#fulldepositfee).
