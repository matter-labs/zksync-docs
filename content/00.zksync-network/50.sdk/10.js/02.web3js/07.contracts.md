...
description: Deploy smart contracts to ZKsync chains
...
- `createAccount`: Deploy a smart contract for a [smart account](/zksync-protocol/era-vm/account-abstraction)
with a non-deterministic address.
- `create2Account`: Deploy a smart contract for a [smart account](/zksync-protocol/era-vm/account-abstraction)
