...
9.  Next, either import one of the rich wallets from `anvil` to your browser wallet using one of the private keys logged when starting the node, or use the command below to send some test ETH to your wallet.<!-- markdownlint-disable-line -->
