...
For the lower-level execution model and tradeoffs, see the [EVM Bytecode Interpreter documentation](/zksync-network/zksync-era/unique-features#evm-bytecode-interpreter).
::
