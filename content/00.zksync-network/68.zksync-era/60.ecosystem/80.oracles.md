...
[DIA](https://www.diadata.org/docs/guides/chain-specific-guide/zksync) delivers verifiable data feeds for 20,000+ 
assets across all major asset classes. It sources raw trade data directly from primary markets and computes it onchain. 
Check out the DIA docs to configure a feed for your use case.
