...
you can get testnet funds from one of many [testnet faucets](/zksync-network/zksync-era/ecosystem#faucets)
to use with [deploying your first smart contract](/zksync-network/quick-start).
