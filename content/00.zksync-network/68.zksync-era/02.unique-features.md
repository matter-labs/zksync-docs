---
title: "Features"
description: "Learn about the features available on ZKsync Era and other ZKsync
  chains powered by EraVM, including native Account Abstraction, Paymasters,
  and the EVM Bytecode Interpreter"
---

ZKsync Era and other ZKsync chains powered by EraVM introduce several
protocol-level features that extend Ethereum’s capabilities while maintaining
...
The following features apply to ZKsync Era and other ZKsync chains powered by EraVM.
::

## Native Account Abstraction

ZKsync Era and other ZKsync chains powered by EraVM natively support
**Account Abstraction (AA)**, allowing accounts to include custom logic at the
protocol level.
...
ZKsync Era and other ZKsync chains powered by EraVM also include native support for **Paymasters**, an extension of the Account Abstraction model introduced
...
The **EVM Bytecode Interpreter** on ZKsync Era and other ZKsync chains powered by EraVM provides runtime compatibility for Ethereum smart contracts.
...
without requiring [custom Hardhat plugins](/zksync-network/zksync-era/custom-tooling#hardhat-zksync) or [custom Foundry forks](/zksync-network/zksync-era/custom-tooling#foundry-zksync).
