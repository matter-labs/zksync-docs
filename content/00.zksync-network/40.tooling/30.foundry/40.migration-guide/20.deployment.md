...
[Differences with address derivation](/zksync-protocol/era-vm/differences/evm-instructions#address-derivation).
...
[Bytecode hashes output by `zksolc` are fundamentally different](/zksync-protocol/era-vm/contracts/bootloader#bytecode-hashes)
