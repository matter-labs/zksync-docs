...
This documentation explains the basics of the ZKsync External Node.
...
- Locally recreate and verify a ZKsync chain's mainnet/testnet state.
- Interact with the recreated state in a trustless way (in a sense that the validity is locally verified, and you should
  not rely on a third-party API ZKsync chain provides).
