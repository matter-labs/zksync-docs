...
- A wallet with ETH is needed to deploy contracts. Visit the
[Network Faucets](/zksync-network/zksync-era/ecosystem/network-faucets) page to get testnet funds.
