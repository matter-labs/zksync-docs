...
Bundles only require one signature on the origin chain,
...
The `InteropHandler` contract is used to execute bundles.

### Example: Constructing a bundle
