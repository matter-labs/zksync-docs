...
1. Automatic crosschain transactions and shadow accounts (??)

Messaging is available on ZKsync Era mainnet as a part of the `v29` upgrade.
Asset transfers and transaction bundles will be available as part of the `v31` upgrade.
