...
9. Copy and paste the script below into the `interop-asset-transfer.ts` file. <!-- markdownlint-disable-line -->
    ...
    ```ts
    :code-import{filePath="local-zksync-os/scripts/interop-asset-transfer-from-l1-viem.ts"}
    ```
...
13. Copy and paste the Gateway migration script below into `scripts/interop-asset-migration.ts`. <!-- markdownlint-disable-line -->
    ...
    ```ts
    :code-import{filePath="local-zksync-os/scripts/interop-asset-migration-viem.ts"}
    ```
...
:display_partial{path="_partials/_zksyncos/_run-script-interop-migration"}

15. Copy and paste the script below into the `interop-asset-transfer.ts` file. <!-- markdownlint-disable-line -->
