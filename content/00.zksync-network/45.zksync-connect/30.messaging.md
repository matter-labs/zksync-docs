...
For a full step-by-step tutorial for sending and verifying interop messages using `zksync-js`,
check out the [interop messages guide](/zksync-network/zksync-connect/guides/interop-messages).
