...
1. **Execute bundles of calls atomically:** Group multiple remote calls into a single bundle, ensuring all of them execute at once.
...
3. **Interop Root Update**: The shared interop/message root gets updated to include the source chain's new message root.
...
1. Atomic [Asset transfers](/zksync-network/zksync-connect/crosschain-asset-transfers),
...
Messaging is already available on all ZKsync chains.
