...
1. [Asset transfers](/zksync-network/unique-features/zksync-connect/crosschain-asset-transfers),
    and [transaction bundles](/zksync-network/unique-features/zksync-connect/transaction-bundles)
...
Asset transfers and transaction bundles is currently only available for local testing,
