...
These integrations, assets, and tools will be accessible to other ZKsync chains through **ZKsync Connect**,
ensuring that all chains in the Elastic Network benefit from the same liquidity, tooling,
...
Era also supports **native account abstraction**, enabling smart wallets, flexible fee payments using ERC-20 tokens,
