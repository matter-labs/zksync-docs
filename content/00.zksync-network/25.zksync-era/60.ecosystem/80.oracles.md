...
[Stork](https://docs.stork.network) delivers price data at ultra-low latency with high reliability 
and uptime, supporting perpetuals markets, lending protocols, and DeFi ecosystems. Price feeds for 
new digital assets are available from Day 1. Review available [price feeds](https://data.stork.network) 
to get started.
