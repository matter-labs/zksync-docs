...
We can change and default index for not specified networks if we override `default` name with index that we want.
...
- `tags` An array of strings representing labels that can be assigned to scripts for categorization and organization.
