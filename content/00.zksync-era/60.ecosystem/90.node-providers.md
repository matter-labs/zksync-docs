...
[Grove](https://grove.city) provides [free public access](https://www.grove.city/public-endpoints) and [private access](https://portal.grove.city/) to ZKsync API endpoint for your
project through the decentralized and unstoppable [Pocket Network](https://pocket.network/).
