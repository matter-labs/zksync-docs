...
Calls the [`zks_getBlockDetails`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getblockdetailss) JSON-RPC method.
...
Calls the [`zks_L1BatchNumber`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_l1batchnumber) JSON-RPC method.
...
Calls the [`zks_getMainContract`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getmaincontractt) JSON-RPC method.
...
Calls the [`zks_getL2ToL1MsgProof`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getl2tol1msgproof) JSON-RPC method.
