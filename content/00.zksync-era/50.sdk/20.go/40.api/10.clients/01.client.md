...
| ----------- | ---------------------------------------- | ---------------------------------------------------------------- |
| `ctx`       | `context.Context`                        | Context.                                                         |
| `msg`       | [`zkTypes.CallMsg`](/zksync-era/sdk/go/api/types#callmsg) | Contains parameters for contract call using EIP-712 transaction. |
...
| --------- | -------------------------------------------------- | -------------------------------------- |
| `ctx`     | `context.Context`                                  | Context.                               |
| `msg`     | [`TransferCallMsg`](/zksync-era/sdk/go/api/accounts/types#transfercallmsg) | Contains parameters for transfer call. |
...
| --------- | ------------------------------------------------------ | ---------------------------------------- |
| `ctx`     | `context.Context`                                      | Context.                                 |
| `msg`     | [`WithdrawalCallMsg`](/zksync-era/sdk/go/api/accounts/types#withdrawalcallmsg) | Contains parameters for withdrawal call. |
...
| --------- | ------------------------------------------- | ---------------------------------------------------------------- |
| `ctx`     | `context.Context`                           | Context.                                                         |
| `msg`     | [`zkTypes.CallMsg`](/zksync-era/sdk/go/api/accounts/types#callmsg) | Contains parameters for contract call using EIP-712 transaction. |
...
as found in [`Log`](/zksync-era/sdk/go/api/types#log). The `FilterLogs` method is kept in order to be compatible with `bind.ContractBackend`,
...
in [`Log`](/zksync-era/sdk/go/api/types#log). The `SubscribeFilterLogs` method is
...
| `ctx`     | `context.Context`                                                                             | Context.                   |
| `query`   | [`ethereum.FilterQuery`](https://pkg.go.dev/github.com/ethereum/go-ethereum@v1.12.0#FilterQuery) | Filter query parameters.   |
| `ch`      | [`chan<- zkTypes.Log`](/zksync-era/sdk/go/api/types#log)                                                       | Channel that receives Log. |
