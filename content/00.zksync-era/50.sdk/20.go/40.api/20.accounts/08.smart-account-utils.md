...
| `client`  | [`*clients.Client`](/go/api/clients/client)         | The client which fetches data from the network. |
...
| `secret`   | `string`                                    | The ECDSA private key.               |
| `client`   | [`*clients.Client`](/go/api/clients/client) | Not used and should be `nil`.         |
