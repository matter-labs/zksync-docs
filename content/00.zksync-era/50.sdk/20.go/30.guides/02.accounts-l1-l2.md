...
This section explores the methods which allow the [account](../../go/api/accounts/index) to send transactions
among both L1 to
...
Full examples of actions below are available on the [getting started](../guides/index) page.
::
