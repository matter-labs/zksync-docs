...
Signs a typed data using the provided [`PayloadSigner`](/zksync-era/sdk/js/ethers/api/v5/types#payloadsigner) function.
...
| Parameter  | Type                                  | Description                                    |
| ---------- | ------------------------------------- | ---------------------------------------------- |
| `provider` | [`Provider`](/zksync-era/sdk/js/ethers/api/v5/providers/provider) | The provider to connect the `SmartAccount` to. |
...
By default, uses [`signPayloadWithECDSA`](/zksync-era/sdk/js/ethers/api/v5/utilities/smart-account-utils#populatetransactionecdsa)
and [`populateTransactionECDSA`](/zksync-era/sdk/js/ethers/api/v5/utilities/smart-account-utils#populatetransactionecdsa).

#### Inputs

| Parameter  | Type                                                  | Description                                         |
| ---------- | ----------------------------------------------------- | --------------------------------------------------- |
| `signer`   | [`SmartAccountSigner`](/zksync-era/sdk/js/ethers/api/v5/types#smartaccountsigner) | Contains necessary properties for signing payloads. |
| `provider` | [`Provider`](/zksync-era/sdk/js/ethers/api/v5/providers/provider)                 | The provider to connect to (optional).              |
...
provided [`TransactionBuilder`](/zksync-era/sdk/js/ethers/api/v5/types#transactionbuilder) function.
If `tx.from` is not set, it sets the value from the `getAddress` method which can
be utilized in the [`TransactionBuilder`](/zksync-era/sdk/js/ethers/api/v5/types#transactionbuilder) function.

#### Inputs

| Parameter | Type                                                  | Description                                 |
| --------- | ----------------------------------------------------- | ------------------------------------------- |
| `tx`      | [`TransactionRequest`](/zksync-era/sdk/js/ethers/api/v5/types#transactionrequest) | The transaction that needs to be populated. |
...
| Parameter | Type                                                  | Description                            |
| --------- | ----------------------------------------------------- | -------------------------------------- |
| `tx`      | [`TransactionRequest`](/zksync-era/sdk/js/ethers/api/v5/types#transactionrequest) | The transaction that needs to be sent. |
...
Signs a `message` using the provided [`PayloadSigner`](/zksync-era/sdk/js/ethers/api/v5/types#payloadsigner) function.
...
Signs the transaction `tx` using the provided [`PayloadSigner`](/zksync-era/sdk/js/ethers/api/v5/types#payloadsigner) function,
...
| Parameter | Type                                                  | Description                              |
| --------- | ----------------------------------------------------- | ---------------------------------------- |
| `tx`      | [`TransactionRequest`](/zksync-era/sdk/js/ethers/api/v5/types#transactionrequest) | The transaction that needs to be signed. |
