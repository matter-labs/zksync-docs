...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](/zksync-era/sdk/js/ethers/api/v5/providers/provider) | A ZKsync node provider. |
...
| `providerL2?` | [`Provider`](/zksync-era/sdk/js/ethers/api/v5/providers/provider)                                                         | A ZKsync node provider. Needed for interaction with ZKsync. |
...
Returns the [parameters](/zksync-era/sdk/js/ethers/api/v5/types#finalizewithdrawalparams) required for finalizing a withdrawal
