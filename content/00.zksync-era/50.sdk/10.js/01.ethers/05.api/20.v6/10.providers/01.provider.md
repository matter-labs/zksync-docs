...
Returns an estimated [`Fee`](/zksync-era/sdk/js/ethers/api/v6/types#fee) for the requested transaction.
...
| `paymasterParams?` | [`PaymasterParams`](/zksync-era/sdk/js/ethers/api/v6/types#paymasterparams)              | Paymaster parameters.  |
...
| Parameter       | Type                                  | Description                                       |
| --------------- | ------------------------------------- | ------------------------------------------------- |
| `zksyncNetwork` | [`ZkSyncNetwork`](/zksync-era/sdk/js/ethers/api/v6/types#network) | Type of ZKsync network. `Localhost` _by default_. |
...
Returns Merkle [`proofs`](/zksync-era/sdk/js/ethers/api/v6/types#storageproof) for one or more storage values at the
...
Calls the [`zks_getTransactionDetails`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_gettransactiondetails)
JSON-RPC method.
...
Calls the [`unstable_sendRawTransactionWithDetailedOutput`](https://docs.zksync.io/build/api.html#unstable_sendRawTransactionWithDetailedOutput)
JSON-RPC method.
