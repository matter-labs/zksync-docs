...
| Parameter       | Type                                                                   | Description                                    |
| --------------- | ---------------------------------------------------------------------- | ---------------------------------------------- |
| `transaction`   | `Transaction` or [`TransactionRequest`](/js/ethers/api/v6/types#transactionrequest) | EIP-712 transaction.                           |
| `ethSignature?` | [`EthereumSignature`](/js/ethers/api/v6/types#ethereumsignature)                    | ECDSA signature of the transaction. |
...
::callout{icon="i-heroicons-light-bulb", to="https://docs.zksync.io/build/developer-reference/bridging-asset.html#default-bridges"}
