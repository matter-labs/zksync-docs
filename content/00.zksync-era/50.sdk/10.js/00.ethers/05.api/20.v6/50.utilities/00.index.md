...
::callout
See also [`undol1tol2alias`](/zksync-era/sdk/js/ethers/api/v6/utilities#undol1tol2alias).
::
...
| Parameter       | Type                                                                   | Description                                    |
| --------------- | ---------------------------------------------------------------------- | ---------------------------------------------- |
| `transaction`   | `Transaction` or [`TransactionRequest`](/zksync-era/sdk/js/ethers/api/v6/types#transactionrequest) | EIP-712 transaction.                           |
| `ethSignature?` | [`EthereumSignature`](/zksync-era/sdk/js/ethers/api/v6/types#ethereumsignature)                    | ECDSA signature of the transaction. |
