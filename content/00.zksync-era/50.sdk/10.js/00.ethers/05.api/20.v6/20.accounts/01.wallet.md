...
| Parameter  | Type                                  | Description             |
| ---------- | ------------------------------------- | ----------------------- |
| `provider` | [`Provider`](/js/ethers/api/v6/providers/provider) | A ZKsync node provider. |
...
| `providerL2?` | [`Provider`](/js/ethers/api/v6/providers/provider)                                                | A ZKsync node provider. Needed for interaction with ZKsync. |
...
use the [`allowanceL1`](/js/ethers/api/v6/accounts/wallet#getallowancel1) method.
...
Returns the [parameters](/js/ethers/api/v6/types#finalizewithdrawalparams) required for
...
Retrieves the full needed ETH fee for the deposit. Returns the L1 fee and the L2 fee [`FullDepositFee`](/js/ethers/api/v6/types#fulldepositfee).
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `tx`      | [`TransactionRequest`](/js/ethers/api/v6/types#transactionrequest) | Transaction request. |
