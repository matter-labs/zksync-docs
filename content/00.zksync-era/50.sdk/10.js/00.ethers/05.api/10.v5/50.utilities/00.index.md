...
<!-- TODO: @itsacoyote fix the to prop -->
...
| Parameter | Type                                                  | Description          |
| --------- | ----------------------------------------------------- | -------------------- |
| `receipt` | [`TransactionReceipt`](/js/ethers/api/v5/types#transactionreceipt) | Transaction receipt. |
...
| Parameter       | Type                                                  | Description                          |
| --------------- | ----------------------------------------------------- | ------------------------------------ |
| `txReceipt`     | [`TransactionReceipt`](/js/ethers/api/v5/types#transactionreceipt) | Receipt of the L1 transaction.       |
