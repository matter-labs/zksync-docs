...
Calls the [`zks_estimateL1ToL2`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_estimategasl1tol2) JSON-RPC method.
...
Calls the [`zks_getAllAccountBalances`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getallaccountbalances)
JSON-RPC method.
...
Calls the [`zks_getBlockDetails`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getblockdetails) JSON-RPC method.
...
Calls the [`zks_getBytecodeByHash`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getbytecodebyhash) JSON-RPC method.
...
Calls the [`zks_getConfirmedTokens`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getconfirmedtokens)
JSON-RPC method.
...
Calls the [`zks_getL1BatchBlockRange`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getl1batchblockrange)
JSON-RPC method.
...
Calls the [`zks_getL1BatchDetails`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getl1batchdetails) JSON-RPC method.
...
Calls the [`zks_getL1BatchNumber`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_l1batchnumber) JSON-RPC method.
...
Calls the [`zks_getL2ToL1LogProof`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getl2tol1logproof) JSON-RPC method.
...
Calls the [`zks_getMainContract`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getmaincontract) JSON-RPC method.
...
Calls the [`zks_getProof`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getproof) JSON-RPC method.
...
Calls the [`zks_getRawBlockTransactions`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_getrawblocktransactions)
JSON-RPC method.
...
Calls the [`getTransactionDetails`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_gettransactiondetails)
JSON-RPC method.
...
Calls the [`zks_L1ChainId`](https://docs.zksync.io/zksync-protocol/api/zks-rpc#zks_l1chainid) JSON-RPC method.
