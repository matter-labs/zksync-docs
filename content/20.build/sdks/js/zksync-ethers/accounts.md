...
the `BrowserProvider`. This structure extends `ethers.JsonRpcSigner` and so supports all the methods available for it.
...
`ethers.JsonRpcSigner` and so supports all the methods available for it.
