...
- Get testnet `ETH` for zkSync Era using :external-link{text="bridges" href="https://zksync.io/explore#bridges"} to bridge funds to zkSync.
- You know :external-link{text="how to get your private key from your MetaMask wallet" href="https://support.metamask.io/hc/en-us/articles/360015289632-How-to-export-an-account-s-private-key"}.
...
Explore more in the [zksync-cli documentation](../zksync-cli/getting-started.md).
::
...
:external-link{text="@matterlabs/hardhat-zksync-deploy" href="https://www.npmjs.com/package/@matterlabs/hardhat-zksync-deploy"}
...
To extend the configuration to support automatic deployment inside scripts without the need for manually creating a wallet,
