...
The plugin is based on :external-link{text="@openzeppelin/upgrades-core" href="https://www.npmjs.com/package/@openzeppelin/upgrades-core"} plugin
...
:external-link{text="OpenZeppelin Upgrades Plugins" href="https://docs.openzeppelin.com/upgrades-plugins"} within a Hardhat environment on zkSync.
...
:external-link{text="@matterlabs/hardhat-zksync-upgradable" href="https://www.npmjs.com/package/@matterlabs/hardhat-zksync-upgradable"}
...
:external-link{text="OpenZeppelin's documentation" href="https://docs.openzeppelin.com/contracts/4.x/api/proxy#transparent-vs-uups"}.
...
In order for a smart contract implementation to be upgradable, it has to follow specific :external-link{text="rules" href="https://docs.openzeppelin.com/upgrades-plugins/1.x/writing-upgradeable"}.
...
You can learn more about what those restrictions are in :external-link{text="OpenZeppelin's documentation" href="https://docs.openzeppelin.com/upgrades-plugins/1.x/writing-upgradeable"}.
