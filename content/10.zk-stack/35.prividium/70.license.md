...
provides all components required to run a standard ZK chain. Prividium™ adds closed-source enterprise modules that
...
These components allow anyone to deploy, modify and operate a ZK chain without a commercial agreement.
