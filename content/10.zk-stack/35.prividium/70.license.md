...
2. **Request access to downloadable images (for self-hosted setups)**
    ...
    If you want to self-host Prividium for sandbox, POC or testnet, contact

    **prividium@matterlabs.dev**
...
- Sandbox, POC and testnet
  ...
  - Access to images is provided after contacting [prividium@matterlabs.dev](mailto:prividium@matterlabs.dev)
