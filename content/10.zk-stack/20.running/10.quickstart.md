...
This guide is for setting up an Elastic Chain ecosystem and for spinning up your own ZKsync chains
...
- Don't forget to deposit some ETH and fund your accounts on your ZKsync chain. To do so follow the instructions for [Funding accounts](/zk-stack/running/using-a-local-zksync-chain#funding-accounts).
