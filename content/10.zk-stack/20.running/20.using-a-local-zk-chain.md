...
[ZKsync CLI](/zksync-network/zksync-era/custom-tooling#zksync-cli) allows you
to easily interact and develop applications on your ZKsync chain.
...
You can save the chain configurations for your ZKsync chain with ZKsync CLI by
using its chain configuration commands. See the
