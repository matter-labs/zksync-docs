...
description: Migrate your ZKsync chain to settle on ZKsync Gateway
---
...
[Learn more about ZKsync Gateway](../../zksync-protocol/gateway) in the protocol documentation.
...
you may want to test [interoperability across different chains](/zksync-network/unique-features/zksync-connect/interop-messages).
...
- **RPC URLs for all the networks involved**:
  ...
  - ZKsync Gateway: more info in [ZKsync Gateway overview](../../zksync-protocol/gateway).
- **Addresses:**
...
- **Chain identifiers:**
  ...
  - `GATEWAY_CHAIN_ID`: more info in [ZKsync Gateway overview](../../zksync-protocol/gateway).
