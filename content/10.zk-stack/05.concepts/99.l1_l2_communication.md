...
Please read [Bootloader](/zk-stack/components/zksync-evm/bootloader) and
[System contracts](/zk-stack/components/smart-contracts/systenm-contracts)
on the general system contracts / bootloader structure as well as the pubdata structure with Boojum system to understand
[the difference](/build/developer-reference/era-contracts/handling-pubdata)
