...
You can learn more about how interoperability works and how to use it in the [ZKsync Connect](/zksync-network/zksync-connect) documentation.
...
- **User-Level Privacy**: [Prividium™](/zk-stack/prividium/overview) enables user-level privacy while giving the chain operator full visibility.
