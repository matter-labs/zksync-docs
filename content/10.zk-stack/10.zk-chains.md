...
1. **Trustless Validating Bridges**: Ensures that rollups within the ZKsync chain are interconnected without requiring additional trust layers.
...
4. **Security and Trust**: All ZKsync chains must utilize the standardized zkEVM engine to maintain consistent security and operational standards,
...
Gateway is a hub for ZKsync chains proof aggregation.
