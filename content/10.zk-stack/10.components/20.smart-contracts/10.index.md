...
description: Explore the architecture of Layer 2 smart contracts on Ethereum and their role in the elastic chain ecosystem.
---
...
In addition to the primary roles, some smart contracts also support the elastic ZK chain ecosystem.
...
More about L1->L2 operations can be found on
