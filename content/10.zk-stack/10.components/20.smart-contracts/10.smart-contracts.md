...
description: Explore the architecture of Layer 2 smart contracts on Ethereum and their role in the ZK Chain ecosystem.
---
...
In addition to the primary roles, some smart contracts also support the ZK Chain ecosystem.
...
[docs](/build/developer-reference/l1-l2-interopability).
